...
@Repository
public class DynamoDBTemplateAdapter extends TemplateAdapterOperations<Object /*domain model*/, String, UmanoProductEntity /*adapter model*/> /* implements Gateway from domain */ {
